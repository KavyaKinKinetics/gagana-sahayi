...
const copy = {
  ...
  motto: {
    ...
    ml: "എല്ലാർക്കും സ്പേസ് — ശാന്തത, ശ്രദ്ധ, സന്തോഷം!"
  },
  sub: {
    en: "Learn astronaut habits, try quick wellbeing tools, and play myth-busting games.",
    ml: "ബഹിരാകാശ യാത്രികരുടെ ശീലങ്ങൾ എന്തൊക്കെയാണ്? അവരുടെ ദിനചര്യയെ മെച്ചപ്പെടുത്താൻ എന്തെല്ലാം മാർഗങ്ങളുണ്ട്? ശ്രദ്ധയും ശാന്തതയും നിലനിർത്താൻ അവർ ഉപയോഗിക്കുന്ന ചെറിയ ഉപകരണങ്ങളും ഗെയിമുകളും എന്തൊക്കെയാണ്? അവയെല്ലാം ഇവിടെ നിന്ന് മനസ്സിലാക്കാം."
  },
  badges: [
